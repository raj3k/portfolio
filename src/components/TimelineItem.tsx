...
const TimelineItem = ({timeInterval, description, title}: IProps) => {
  return (
    <li className="mb-10 ml-4">
      ...
      <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{ timeInterval }</time>
      ...
      <a href="#"
        ...
        more <svg className="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
